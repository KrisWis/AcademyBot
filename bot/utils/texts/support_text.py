...
support_text = '''
✍️ Задайте свой вопрос, а оператор ответит на него в рабочее время.

‼️ Техническая поддержка на связи с 10:00 до 22:00 по МСК.'''

support_without_graphic_text = '✍️ Задайте свой вопрос — оператор в реальном времени сразу подключится.'
